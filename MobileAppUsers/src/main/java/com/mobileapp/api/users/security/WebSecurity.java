...
public class WebSecurity extends WebSecurityConfigurerAdapter{
	...
	@Autowired
	public WebSecurity(Environment environment,UserSevice userservice,BCryptPasswordEncoder bpasswordEncoder,EventService eventService) {
	...
	public AuthenticationFilter getFilter() throws Exception {
		AuthenticationFilter authenticationFilter=new AuthenticationFilter(userservice,environment,eventService);
